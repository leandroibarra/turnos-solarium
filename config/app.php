...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Turnos Solarium'),
    ...
    */
    ...
    'url' => env('APP_URL', 'http://turnos-solarium.loc'),
    ...
    */
	...
	|--------------------------------------------------------------------------
	|
	| Customize path folder by resource.
	|
	|--------------------------------------------------------------------------
	 */
	'path_folder_by_resource' => [
		'slides' => 'slides'
	],
	...
	|--------------------------------------------------------------------------
	|
	| Customize the separator for the decimal point.
	|
	|--------------------------------------------------------------------------
	 */
