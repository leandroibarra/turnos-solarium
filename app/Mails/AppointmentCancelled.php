...
class AppointmentCancelled extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this
			...
			->subject($aSystemParameters['appointment_cancelled_email_subject'])
			->view('emails.appointment-confirmed')
			->with([
				'sBody' => html_entity_decode($aSystemParameters['appointment_cancelled_email_body']),
				'sName' => $this->oContent->sName,
				'sDate' => $this->oContent->sDate,
				'sTime' => $this->oContent->sTime,
				'sCity' => $this->oContent->sCity,
				'sPhone' => $this->oContent->sPhone,
				'sEmail' => $this->oContent->sEmail,
